...
const NAV_SECTIONS: NavSection[] = [
	...
	{ label: "Calendario", href: "/calendario" },
	{
		label: "Corsi",
		href: "/corsi",
		children: [{ label: "Elenco Corsi", href: "/corsi" }],
	},
...
export function TopNav() {
	...
	return (
		<nav ref={navRef} className="hidden border-b border-border bg-background px-4 lg:block">
						...
						return (
							<div key={section.href} className="relative">
								<button
									type="button"
									onClick={() =>
										setOpenDropdown(openDropdown === section.href ? null : section.href)
									}
