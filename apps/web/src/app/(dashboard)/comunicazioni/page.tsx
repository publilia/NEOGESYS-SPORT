...
const SAMPLE_COMUNICAZIONI: Comunicazione[] = [
	{
		id: "1",
		oggetto: "Rinnovo tessera stagione 2026/2027",
		tipo: "email",
		destinatariCount: 150,
		stato: "inviata",
		data: "2026-04-15",
	},
	{
		id: "2",
		oggetto: "Promemoria allenamento sabato",
		tipo: "sms",
		destinatariCount: 24,
		stato: "inviata",
		data: "2026-04-14",
	...
	{
		id: "6",
		oggetto: "Variazione orario corsi",
		tipo: "sms",
		destinatariCount: 45,
		stato: "errore",
		data: "2026-04-12",
	...
	{
		id: "7",
		oggetto: "Nuovo corso di pilates",
		tipo: "email",
		destinatariCount: 0,
		stato: "bozza",
		data: "2026-04-11",
	...
	{
		id: "8",
		oggetto: "Reminder quota associativa",
		tipo: "whatsapp",
		destinatariCount: 30,
		stato: "programmata",
		data: "2026-04-25",
...
export default function ComunicazioniPage() {
	...
	const filteredData = useMemo(() => {
		...
		if (activeTab === "inviate") {
			data = data.filter(
				(c) => c.stato === "inviata" || c.stato === "in_corso" || c.stato === "errore",
			);
		...
		() => [
			{
				accessorKey: "oggetto",
				header: "Oggetto",
				cell: ({ row }) => <span className="font-medium">{row.getValue("oggetto")}</span>,
			},
			{
				accessorKey: "tipo",
				header: "Tipo",
			...
			},
			{
				...
				header: "Destinatari",
				cell: ({ row }) => <span className="text-sm">{row.getValue("destinatariCount")}</span>,
			},
			{
				accessorKey: "stato",
				header: "Stato",
	...
	return (
		<div className="space-y-6 p-6">
			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				<div>
					<h1 className="text-3xl font-bold tracking-tight text-foreground">Comunicazioni</h1>
					<p className="text-muted-foreground">Invia email, SMS e messaggi WhatsApp ai tuoi soci</p>
				</div>
				<Link
