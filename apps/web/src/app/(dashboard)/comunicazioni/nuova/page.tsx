...
const CANALE_CONFIG: Record<Canale, { label: string; icon: typeof Mail; description: string }> = {
	email: {
		label: "Email",
		icon: Mail,
		description: "Invia un messaggio email con oggetto e corpo",
	},
	sms: { label: "SMS", icon: Smartphone, description: "Invia un breve messaggio di testo" },
	whatsapp: {
		label: "WhatsApp",
		icon: MessageSquare,
		description: "Invia un messaggio tramite WhatsApp",
	},
};
...
> = {
	...
	per_disciplina: {
		label: "Per disciplina",
		icon: Dumbbell,
		description: "Seleziona una disciplina",
	},
	manuale: {
		label: "Selezione manuale",
		icon: UserPlus,
		description: "Scegli i destinatari singolarmente",
	},
};
...
const SAMPLE_DISCIPLINE = ["Calcio", "Nuoto", "Tennis", "Pallavolo", "Ginnastica", "Basket"];
			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				<div className="flex items-center gap-3">
					...
					<div>
						...
						<p className="text-muted-foreground">Componi e invia un messaggio ai tuoi soci</p>
					</div>
				</div>
			</div>
