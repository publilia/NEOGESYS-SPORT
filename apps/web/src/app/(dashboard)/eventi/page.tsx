...
const SAMPLE_EVENTI: Evento[] = [
  ...
  },
  {
    ...
    stato: "aperto",
    partecipanti: [
      { nome: "Anna", cognome: "Verdi", tessera: "SOC-003" },
    ],
  },
  {
    id: "3",
  ...
  },
  {
    ...
    stato: "in_corso",
    partecipanti: [
      { nome: "Sara", cognome: "Blu", tessera: "SOC-006" },
    ],
  },
];
...
export default function EventiPage() {
  ...
  const discipline = useMemo(
    () => [...new Set(SAMPLE_EVENTI.map((e) => e.disciplina))],
    [],
  );
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestisci gare, tornei, stage, saggi e raduni
          </p>
        </div>
        <Link
          href="/eventi/nuovo"
