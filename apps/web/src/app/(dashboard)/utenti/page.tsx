...
const SAMPLE_UTENTI: Utente[] = [
  { id: "1", nome: "Marco", cognome: "Amministratore", email: "marco@associazione.it", ruolo: "admin", stato: "attivo", ultimoAccesso: "2026-04-17T10:30:00" },
  { id: "2", nome: "Laura", cognome: "Segretaria", email: "laura@associazione.it", ruolo: "segreteria", stato: "attivo", ultimoAccesso: "2026-04-17T09:15:00" },
  { id: "3", nome: "Paolo", cognome: "Rossi", email: "paolo.rossi@associazione.it", ruolo: "istruttore", stato: "attivo", ultimoAccesso: "2026-04-16T18:45:00" },
  { id: "4", nome: "Chiara", cognome: "Neri", email: "chiara.neri@associazione.it", ruolo: "istruttore", stato: "attivo", ultimoAccesso: "2026-04-16T17:00:00" },
  { id: "5", nome: "Giuseppe", cognome: "Verdi", email: "giuseppe.verdi@associazione.it", ruolo: "visualizzatore", stato: "attivo", ultimoAccesso: "2026-04-15T14:20:00" },
  { id: "6", nome: "Francesca", cognome: "Blu", email: "francesca.blu@associazione.it", ruolo: "istruttore", stato: "disabilitato", ultimoAccesso: "2026-03-20T11:00:00" },
];
  ...
  const columns = useMemo<ColumnDef<Utente>[]>(
    () => [
      ...
      },
      {
        ...
        header: "Cognome",
        cell: ({ row }) => (
          <span className="font-medium">{row.getValue("cognome")}</span>
        ),
      },
      {
        accessorKey: "email",
