...
const SAMPLE_CERTIFICATI = [
	{
		id: "1",
		tipo: "Certificato medico agonistico",
		stato: "valido" as StatoCertificato,
	...
	{
		id: "2",
		tipo: "Certificato medico non agonistico",
		stato: "scaduto" as StatoCertificato,
...
const SAMPLE_QUOTE = [
	{
		id: "1",
		descrizione: "Quota associativa 2026",
		importo: 120,
		stato: "pagata",
	...
	{
		id: "2",
		descrizione: "Iscrizione Calcio Under 12",
		importo: 80,
		stato: "pagata",
	...
	{
		id: "3",
		descrizione: "Quota associativa 2025",
		importo: 100,
		stato: "pagata",
...
const SAMPLE_DOCUMENTI = [
	{
		id: "1",
		nome: "Certificato medico 2026.pdf",
		tipo: "certificato",
		data: "2026-01-10",
		dimensione: "245 KB",
	},
...
const SAMPLE_STORICO = [
	{
		...
		dettagli: "Accesso da dispositivo mobile",
	},
	{
		id: "2",
		data: "2026-01-10",
		azione: "Certificato caricato",
		dettagli: "Certificato medico agonistico",
	},
	{
		id: "3",
		data: "2026-01-05",
		azione: "Pagamento ricevuto",
		dettagli: "Quota associativa 2026 - 120,00 EUR",
	},
	{ id: "4", data: "2025-09-10", azione: "Iscritto a corso", dettagli: "Calcio Under 12" },
	{
		...
		data: "2024-09-01",
		azione: "Socio creato",
		dettagli: "Prima iscrizione all'associazione",
	},
];
					...
					<div className="flex items-center gap-4">
						...
						<div>
							...
							<div className="mt-1 flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
								...
								<span>&middot;</span>
								<span>
									Iscritto dal {new Date(socio.dataIscrizione).toLocaleDateString("it-IT")}
								</span>
							</div>
						</div>
					</div>
					...
					<div className="grid gap-4 sm:grid-cols-2">
						...
						<div>
							...
							<p className="mt-1 text-sm text-foreground">
								{new Date(socio.dataNascita).toLocaleDateString("it-IT")}
							</p>
						</div>
						<div>
							<p className="text-xs font-medium uppercase tracking-wider text-muted-foreground">
									...
									return (
										...
										>
											...
											<td className="px-4 py-3 text-sm">
												<span
													className={`inline-flex items-center gap-1.5 ${CERT_STATUS_COLORS[cert.stato]}`}
												>
