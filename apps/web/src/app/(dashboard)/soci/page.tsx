...
const SAMPLE_SOCI: Socio[] = [
  { id: "1", tessera: "SOC-001", nome: "Mario", cognome: "Rossi", disciplina: "Calcio", stato: "attivo", certificato: "valido" },
  { id: "2", tessera: "SOC-002", nome: "Luca", cognome: "Bianchi", disciplina: "Nuoto", stato: "attivo", certificato: "scaduto" },
  { id: "3", tessera: "SOC-003", nome: "Anna", cognome: "Verdi", disciplina: "Tennis", stato: "scaduto", certificato: "mancante" },
  { id: "4", tessera: "SOC-004", nome: "Giulia", cognome: "Neri", disciplina: "Pallavolo", stato: "attivo", certificato: "valido" },
  { id: "5", tessera: "SOC-005", nome: "Paolo", cognome: "Gialli", disciplina: "Basket", stato: "sospeso", certificato: "valido" },
  { id: "6", tessera: "SOC-006", nome: "Sara", cognome: "Blu", disciplina: "Calcio", stato: "in_attesa", certificato: "mancante" },
];
...
export default function SociPage() {
  ...
  const disciplines = useMemo(
    () => [...new Set(SAMPLE_SOCI.map((s) => s.disciplina))],
    [],
  );
    ...
    () => [
      {
        ...
        header: "Tessera",
        cell: ({ row }) => (
          <span className="font-mono text-sm">{row.getValue("tessera")}</span>
        ),
      },
      {
        accessorKey: "cognome",
        ...
        cell: ({ row }) => (
          <div className="relative">
            <button
              ...
              onClick={() =>
                setOpenActions(
                  openActions === row.original.id ? null : row.original.id,
                )
              }
            >
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestisci i soci della tua associazione
          </p>
        </div>
