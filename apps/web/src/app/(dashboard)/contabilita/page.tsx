...
const SAMPLE_MOVIMENTI: Movimento[] = [
	{
		...
		descrizione: "Rossi Mario - Rinnovo annuale",
		tipo: "entrata",
		importo: 120,
		saldo: 15420,
	},
	{
		id: "2",
		data: "2026-04-15",
		causale: "Stipendio istruttore",
		descrizione: "Bianchi Marco - Aprile 2026",
		tipo: "uscita",
		importo: 1200,
		saldo: 15300,
	},
	{
		...
		descrizione: "Verdi Anna - Nuoto Principianti",
		tipo: "entrata",
		importo: 80,
		saldo: 16500,
	},
	{
		...
		data: "2026-04-13",
		causale: "Utenze",
		descrizione: "Bolletta energia elettrica - Marzo",
		tipo: "uscita",
		importo: 450,
		saldo: 16420,
	},
	{
		id: "5",
		data: "2026-04-12",
		causale: "Materiale sportivo",
		descrizione: "Palloni calcio x20",
		tipo: "uscita",
		importo: 300,
		saldo: 16870,
	},
	{
		id: "6",
		data: "2026-04-11",
		causale: "Sponsorizzazione",
		descrizione: "Sponsor locale - Trimestre Q2",
		tipo: "entrata",
		importo: 2000,
		saldo: 17170,
	},
	{
		...
		data: "2026-04-10",
		causale: "Quota associativa",
		descrizione: "Neri Giulia - Rinnovo annuale",
		tipo: "entrata",
		importo: 120,
		saldo: 15170,
	},
	{
		id: "8",
		data: "2026-04-09",
		causale: "Manutenzione",
		descrizione: "Riparazione rete campo tennis",
		tipo: "uscita",
		importo: 180,
		saldo: 15050,
	},
	...
	const columns = useMemo<ColumnDef<Movimento>[]>(
		() => [
			...
			},
			{
				accessorKey: "causale",
				header: "Causale",
				cell: ({ row }) => <span className="text-sm font-medium">{row.getValue("causale")}</span>,
			},
			{
	...
	return (
		<div className="space-y-6 p-6">
			...
			<div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
				<div>
					<h1 className="text-3xl font-bold tracking-tight text-foreground">Contabilita</h1>
					<p className="text-muted-foreground">Gestisci la prima nota e i movimenti contabili</p>
				</div>
				...
				<div className="rounded-xl border border-border bg-card p-5">
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="text-xl font-bold text-foreground">{saldo.toFixed(2)} &euro;</p>
						</div>
					</div>
				</div>
			</div>
			...
			{activeTab === "export" && (
				<div className="rounded-lg border border-border bg-card p-6">
					...
					<p className="mb-6 text-sm text-muted-foreground">
						Scarica i movimenti contabili nel formato desiderato. I filtri attivi vengono applicati
						all&apos;export.
					</p>
					<div className="grid gap-4 sm:grid-cols-2">
						...
						>
							...
							<div>
								...
								<p className="text-sm text-muted-foreground">
									Documento formattato per stampa e archiviazione
								</p>
							</div>
							<Download className="ml-auto h-5 w-5 text-muted-foreground" />
						</button>
