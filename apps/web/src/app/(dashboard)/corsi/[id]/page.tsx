...
const SAMPLE_CORSO = {
  ...
  iscrittiAttuali: 18,
  capacitaMassima: 20,
  descrizione: "Corso di calcio per ragazzi dai 10 ai 12 anni. Allenamenti bisettimanali con focus su tecnica individuale e gioco di squadra.",
};

const SAMPLE_ISCRITTI = [
  { id: "1", tessera: "SOC-001", nome: "Mario", cognome: "Rossi", stato: "attivo", certificato: "valido" },
  { id: "2", tessera: "SOC-002", nome: "Luca", cognome: "Bianchi", stato: "attivo", certificato: "valido" },
  { id: "3", tessera: "SOC-003", nome: "Anna", cognome: "Verdi", stato: "attivo", certificato: "scaduto" },
  { id: "4", tessera: "SOC-004", nome: "Giulia", cognome: "Neri", stato: "attivo", certificato: "valido" },
  { id: "5", tessera: "SOC-005", nome: "Paolo", cognome: "Gialli", stato: "attivo", certificato: "valido" },
  { id: "6", tessera: "SOC-007", nome: "Andrea", cognome: "Marroni", stato: "attivo", certificato: "valido" },
];
...
const ORARIO_SETTIMANALE = [
  ...
  { giorno: "Mercoledi", orario: "16:00 - 17:30", luogo: "Campo A", attivita: "Partitella e tattica" },
];
    ...
    <div className="space-y-6 p-6">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">Tessera</th>
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">Cognome</th>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">Certificato</th>
                </tr>
              </thead>
              <tbody>
                {SAMPLE_ISCRITTI.map((socio) => (
                  <tr key={socio.id} className="border-b border-border last:border-0 hover:bg-muted/30">
                    ...
                    <td className="px-4 py-3 text-sm">
                      <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium capitalize ${CERT_COLORS[socio.certificato]}`}>
                        {socio.certificato}
                      </span>
                    </td>
                  </tr>
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-card">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-muted-foreground">Socio</th>
                  ...
                  <th className="px-4 py-3 text-center text-xs font-medium uppercase tracking-wider text-muted-foreground">%</th>
                </tr>
              </thead>
              <tbody>
                {SAMPLE_ISCRITTI.map((socio) => {
      ...
      {activeTab === "impostazioni" && (
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="corso-nome" className="mb-1.5 block text-sm font-medium text-foreground">
                Nome del corso
              </label>
              <input
                id="corso-nome"
            ...
            <div>
              <label htmlFor="corso-descrizione" className="mb-1.5 block text-sm font-medium text-foreground">
                Descrizione
              </label>
              <textarea
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="corso-istruttore" className="mb-1.5 block text-sm font-medium text-foreground">
                  Istruttore
                </label>
                <input
                  id="corso-istruttore"
              ...
              <div>
                <label htmlFor="corso-capacita" className="mb-1.5 block text-sm font-medium text-foreground">
                  Capacita massima
                </label>
                <input
                  id="corso-capacita"
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="corso-luogo" className="mb-1.5 block text-sm font-medium text-foreground">
                  Luogo
                </label>
                <input
                  id="corso-luogo"
              ...
              <div>
                <label htmlFor="corso-disciplina" className="mb-1.5 block text-sm font-medium text-foreground">
                  Disciplina
                </label>
                <input
                  id="corso-disciplina"
