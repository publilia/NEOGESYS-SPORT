...
export default function DashboardPage() {
	return (
		<div className="space-y-8">
			{/* Welcome */}
			<div>
				<h1 className="text-2xl font-bold text-foreground">Benvenuto, Marco</h1>
			...
			{/* Recent Activity */}
			<div>
				<h2 className="text-lg font-semibold text-foreground">Attivita recenti</h2>
				<div className="mt-3 rounded-xl border border-border bg-card">
					<div className="divide-y divide-border">
						{[
							...
							<div key={activity.text} className="flex items-center justify-between px-5 py-3">
