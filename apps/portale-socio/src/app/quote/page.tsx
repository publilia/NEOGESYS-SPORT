...
import { AlertTriangle, CheckCircle2, Clock, CreditCard, Download } from "lucide-react";
				...
				<div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4">
					<div className="flex items-center justify-between">
						<div className="flex items-center gap-3">
							...
							<div>
								<p className="text-sm font-medium text-foreground">Hai pagamenti in sospeso</p>
					...
					<table className="w-full text-sm">
						<thead>
							<tr className="border-b border-border">
								...
								<th className="px-5 py-3 text-left font-medium text-muted-foreground">Importo</th>
								...
								<th className="px-5 py-3 text-right font-medium text-muted-foreground">Azioni</th>
							</tr>
						</thead>
						<tbody className="divide-y divide-border">
							{quote.map((q) => (
								<tr key={q.id} className="hover:bg-accent/30">
									<td className="px-5 py-4 font-medium text-foreground">{q.descrizione}</td>
									<td className="px-5 py-4 text-foreground">{q.importo.toFixed(2)} EUR</td>
									<td className="px-5 py-4 text-muted-foreground">{q.scadenza}</td>
