import { type Database, db } from "@neogesys/db";
import { type TenantVault, createVault } from "@neogesys/vault";
import type { CreateFastifyContextOptions } from "@trpc/server/adapters/fastify";
import { type UserContext, resolveUser } from "../middleware/auth";
