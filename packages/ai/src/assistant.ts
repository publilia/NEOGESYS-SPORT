...
export const assistantTools = [
  ...
  },
  {
    name: "presenze_corso",
    description:
      "Recupera le presenze per un corso specifico o per un socio specifico.",
    input_schema: {
      type: "object" as const,
      properties: {
        corsoId: {
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        destinatari: {
          type: "string",
          description: "Descrizione del gruppo destinatario (es. 'tutti i soci attivi', 'corsisti del corso di nuoto')",
        },
      },
...
export async function handleAssistantMessage(
  ...
  const systemPrompt = SYSTEM_PROMPT
    .replace("{tenantNome}", context.tenantNome)
