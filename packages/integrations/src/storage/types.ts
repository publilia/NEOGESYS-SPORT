...
export interface CloudStorageProvider {
	 ...
	 */
	listFiles(folderId?: string, query?: string, pageSize?: number): Promise<UnifiedFileList>;
	 ...
	 */
	shareFile(fileId: string, email: string, role: "reader" | "writer"): Promise<ShareResult>;
